...
// import FilterIcon from 'path/to/FilterIcon'; // Ensure the correct path
// import CloseIcon from 'path/to/CloseIcon'; // Ensure the correct path
// import Slider from 'path/to/Slider'; // Ensure the correct path
